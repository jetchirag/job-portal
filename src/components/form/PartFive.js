    ...
    <Accordion.Item eventKey="4">
      ...
      <Accordion.Body>
        ...
        <Row className="mb-3">
          ...
          {/* Country of job  */}
          <Form.Group as={Col} md="3" controlId="academicExperience_country">
          ...
          {/* University  */}
          <Form.Group as={Col} md="3" controlId="academicExperience_university">
            ...
            {errors.academicExperience_university && (
              <p style={{ color: "red" }}>Please enter your university name</p>
            )}
          </Form.Group>
          {/* College Name  */}
          <Form.Group as={Col} md="3" controlId="academicExperience_college">
          ...
          {/* Postion of work  */}
          <Form.Group as={Col} md="3" controlId="academicExperience_position">
          ...
          <Form.Group as={Col} md="3" controlId="academicExperience_domain">
            ...
            {errors.academicExperience_domain && (
              <p style={{ color: "red" }}>Please enter your academic domain</p>
            )}
          </Form.Group>
          {/* Working From Date Details  */}
          <Form.Group as={Col} md="3" controlId="academicExperience_datefrom">
        ...
        <Row className="mb-3">
          {/* Nature of job  */}
          <Form.Group as={Col} md="3" controlId="nonAcademicExperience_mode">
            <Form.Label>Nature of Job</Form.Label>
            <Form.Select
              size="sm"
          ...
          {/* Country of job  */}
          <Form.Group as={Col} md="3" controlId="nonAcademicExperience_country">
            <Form.Label>Country</Form.Label>
            <CountryDropdown
          ...
          >
            ...
            {errors.nonAcademicExperience_designation && (
              <p style={{ color: "red" }}>Please enter your designation name</p>
            )}
          </Form.Group>
          {/* Department Name  */}
          <Form.Group
          ...
          >
            ...
            {errors.nonAcademicExperience_department && (
              <p style={{ color: "red" }}>Please enter your department name</p>
            )}
          </Form.Group>
          {/* Working From Date Details  */}
          <Form.Group
          ...
          {/* Working To Date Details  */}
          <Form.Group as={Col} md="3" controlId="nonAcademicExperience_dateto">
            <Form.Label>Date To</Form.Label>
            <Form.Control
              size="sm"
              placeholder="DD/MM/YYYY"
