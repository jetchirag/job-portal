        ...
        <Row className="mb-3">
            ...
            <>
              <Form.Group as={Col} md="12">
                ...
                <Form.Check
                  ...
                  value={"Yes"}
                  name={"offerjoined"}
                  checked={props?.data?.offerjoined === "Yes"}
                ...
                <Form.Check
                  ...
                  value={"No"}
                  name={"offerjoined"}
                  checked={props?.data?.offerjoined === "No"}
                  {...register("offerjoined", {
                    required: true,
                  })}
                ></Form.Check>
          ...
          <Form.Group as={Col} md="12">
            ...
            <Form.Check
              ...
              value={"Yes"}
              checked={props?.data?.convicted === "Yes"}
              name={"convicted"}
              {...register("convicted", {
                required: true,
              })}
            ...
            <Form.Check
              ...
              value={"No"}
              name={"convicted"}
              checked={props?.data?.convicted === "No"}
              {...register("convicted", {
                required: true,
              })}
            ></Form.Check>
          ...
          <Form.Group as={Col} md="12">
            ...
            <Form.Check
              ...
              checked={props?.data?.pendingcases === "Yes"}
              id={"pendingcases"}
            ...
            <Form.Check
              ...
              name={"pendingcases"}
              id={"pendingcases"}
              checked={props?.data?.pendingcases === "No"}
              {...register("pendingcases", {
                required: true,
              })}
            ></Form.Check>
...
export default PartTwelveDetails;
