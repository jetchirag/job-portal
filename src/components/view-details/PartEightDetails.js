  ...
  return (
    <Accordion.Item eventKey="8">
      ...
      <Accordion.Body>
        ...
        {/* return ( */}
        <Row className="mb-3">
          <Form.Group as={Col} md="2" controlId="book_details" disabled={part8}>
          ...
          <Form.Group as={Col} md="2" controlId="book_isbn">
            ...
            <Form.Control
              ...
              rows={3}
              disabled={part8}
              value={props?.data?.book_isbn}
              {...register("book_isbn", {
                maxLength: 500,
              })}
            />
            {errors.book_isbn && (
              <p style={{ color: "red" }}>Please enter the book isbn number</p>
            )}
          </Form.Group>
...
export default PartEightDetails;
