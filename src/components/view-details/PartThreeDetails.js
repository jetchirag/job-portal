      ...
      <Accordion.Body>
        ...
        <Row className="mb-3">
          ...
          >
            ...
            >
              <option selected="" disabled="" value="">
                Selected: {props?.data?.aq_secondary_country}
              </option>
          ...
          <Form.Group as={Col} md="2" controlId="higher_secondary_mode">
            ...
            >
              <option selected="" disabled="" value="">
              Selected: {props?.data?.aq_higher_secondary?.mode}
              </option>
          ...
          <Form.Group as={Col} md="2" controlId="school">
            ...
            <Form.Control
              defaultValue={props?.data?.aq_higher_secondary?.school}
          ...
          <Form.Group as={Col} md="2" controlId="division">
            ...
            >
              <option selected="" disabled="" value="">
                Selected: {props?.data?.aq_higher_secondary?.division}
              </option>
          ...
          return (
            <Row className="mb-3">
              ...
              <Form.Group as={Col} md="2" controlId="phd_mode">
                ...
                >
                  <option selected>Selected: {item.mode}</option>
                  <option value="regular">Regular</option>
                  <option value="part-time">Part-Time</option>
                  <option value="distance-learning-online">
                    Distance Learning / Online
              ...
              <Form.Group as={Col} md="2" controlId="phd_teaching_experience">
                ...
                >
                  <option selected>Selected: {item.teaching_experience}</option>
            ...
            return (
              <Row className="mb-3">
                ...
                <Form.Group as={Col} md="2" controlId="mphil_mode">
                  ...
                  >
                    <option value="">Selected:{item.mode} </option>
                    <option value="regular">Regular</option>
                    <option value="part-time">Part-Time</option>
                    <option value="distance-learning-online">
                      Distance Learning / Online
                ...
                <Form.Group as={Col} md="2" controlId="mphil_division">
                  ...
                  >
                    <option value="">Selected: {item.division}</option>
                    <option value="first">First</option>
                    <option value="second">Second</option>
                    <option value="third">Third</option>
                  </Form.Select>
            ...
            return (
              <Row className="mb-3">
                ...
                >
                  ...
                  >
                    <option selected="" disabled="" value="">
                      Selected: {item.aq_post_doctoral_country}
                    </option>
                    {countries?.map((element) => {
                      return (
                        <option value={element.iso2}>{element.name}</option>
                ...
                <Form.Group as={Col} md="2" controlId="post_doctoral_college">
                  ...
                  <Form.Control
                    ...
                    placeholder="College Name"
                    defaultValue={props?.data?.post_doctoral_college}
                    type="text"
